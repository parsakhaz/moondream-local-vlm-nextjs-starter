			...
			<div className='flex flex-col items-center justify-center space-y-4'>
				...
				<div className='w-full max-w-md'>
					<label
						...
						className='flex flex-col items-center justify-center w-full h-64 border-2 border-light-border dark:border-dark-border border-dashed rounded-lg cursor-pointer bg-light-secondary dark:bg-dark-secondary hover:bg-light-accent/10 dark:hover:bg-dark-accent/10 transition-colors'
					>
					...
					<div className='w-full max-w-[1200px] mt-6 space-y-6'>
						...
						<div className='w-full'>
							<Button
								...
								className='w-full mb-4 bg-light-accent dark:bg-dark-accent hover:bg-light-accent/90 dark:hover:bg-dark-accent/90 text-white'
							>
								{isLoading ? 'Analyzing...' : 'Describe Image'}
							</Button>

							{description && (
								<div className='p-4 bg-light-secondary dark:bg-dark-secondary rounded-lg border border-light-border dark:border-dark-border'>
						...
						<div className='flex flex-col lg:flex-row gap-8'>
							...
							<div className='w-full lg:w-1/2'>
								<div className='relative w-full'>
									<Image src={imageUrl} alt='Preview' width={800} height={400} className='rounded-lg' style={{ width: '100%', height: 'auto' }} priority />
								</div>
							</div>

							{/* Right Column: Chat */}
							<AnimatePresence>{showChat && imageKey && <Chat imageKey={imageKey} />}</AnimatePresence>
						</div>
					</div>
				)}
			</div>
